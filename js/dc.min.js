    ...
    function t(t, e) {
        ...
        return n.utils.uniqueId = function() {
                ...
                return t && e ? t.length === e.length && t.every(function(t, n) {
                    return t === e[n] || t.toString() === e[n].toString()
                }) : t === e
                ...
                r.height = function(t) {
                    ...
                    if (n.instanceOfChart(e)) u = e.anchor(), c = e.root(), d = !0;
                    else {
                ...
                function r(r, i) {
                    e.isOrdinal() ? (x.bandwidth || (n.logger.warn("For compatibility with d3v4+, dc.js d3.0 ordinal bar/line/bubble charts need d3.scaleBand() for the x scale, instead of d3.scaleOrdinal(). Replacing .x() with a d3.scaleBand with the same domain - make the same change in your code to avoid this warning!"), x = t.scaleBand().domain(x.domain())), (e.elasticX() || 0 === x.domain().length) && x.domain(e._ordinalXDomain())) : e.elasticX() && x.domain([e.xAxisMin(), e.xAxisMax()]);
                    var a = x.domain();
                    !i && n.utils.arraysEqual(_, a) || e.rescale(), _ = a, e.isOrdinal() ? x.range([0, e.xAxisLength()]).paddingInner(tt).paddingOuter(e._useOuterPadding() ? $ : 0) : x.range([0, e.xAxisLength()]), E = E.scale(e.x()),
                        function(t) {
                            var r = t.select("g." + h);
                            if (I) {
                                r.empty() && (r = t.insert("g", ":first-child").attr("class", f + " " + h).attr("transform", "translate(" + e.margins().left + "," + e.margins().top + ")"));
                                var i = E.tickValues() ? E.tickValues() : "function" == typeof x.ticks ? x.ticks.apply(x, E.tickArguments()) : x.domain(),
                                ...
                                n.transition(o, e.transitionDuration(), e.transitionDelay()).attr("opacity", 1);
                                var l = o.merge(a);
                                n.transition(l, e.transitionDuration(), e.transitionDelay()).attr("x1", function(t) {
                                    return x(t)
                                }).attr("y1", e._xAxisY() - e.margins().top).attr("x2", function(t) {
                                    return x(t)
                ...
                function i() {
                    return et ? t.axisRight() : t.axisLeft()
                }
                ...
                function o() {
                    var t = n.utils.appendOrSelect(p, "defs"),
                        r = a(),
                        i = n.utils.appendOrSelect(t, "#" + r, "clipPath").attr("id", r),
                        o = 2 * Q;
                    n.utils.appendOrSelect(i, "rect").attr("width", e.xAxisLength() + o).attr("height", e.yAxisHeight() + o).attr("transform", "translate(-" + Q + ", -" + Q + ")")
                }

                function l(t) {
                    e.isOrdinal() && (Y = !1), r(e.g(), t), e._prepareYAxis(e.g()), e.plotData(), (e.elasticX() || X || t) && e.renderXAxis(e.g()), (e.elasticY() || X || t) && e.renderYAxis(e.g()), t ? e.renderBrush(e.g(), !1) : e.redrawBrush(e.filter(), X), e.fadeDeselectedArea(e.filter()), X = !1
                }
                ...
                function u(t, r) {
                    ...
                    }(t) ? (e.x().domain(A), i = null) : (e.x().domain(t), i = n.filters.RangedFilter(t[0], t[1])), e.replaceFilter(i), e.rescale(), e.redraw(), r || (R && !d(e.filter(), R.filter()) && n.events.trigger(function() {
                        R.replaceFilter(i), R.redraw()
                ...
                function c() {
                    j && j.transform(e.root(), function(e, n, r) {
                ...
                return e.rescale = function() {
                    return L = void 0, X = !0, e
                }, e.resizing = function() {
                    return X
                }, e.rangeChart = function(t) {
                    return arguments.length ? ((R = t).focusChart(e), e) : R
                    ...
                    return y = p.append("g"), v = y.append("g").attr("class", "chart-body").attr("transform", "translate(" + e.margins().left + ", " + e.margins().top + ")").attr("clip-path", "url(" + n + "#" + a() + ")"), y
                }, e.g = function(t) {
                    ...
                    return arguments.length ? (x = t, A = x.domain(), e.rescale(), e) : x
                    ...
                    return void 0 === L && (e.isOrdinal() ? L = e.x().domain().length : (L = e.xUnits()(e.x().domain()[0], e.x().domain()[1])) instanceof Array && (L = L.length)), L
                }, e.useRightYAxis = function(t) {
                    return arguments.length ? (et !== t && N && n.logger.warn("Value of useRightYAxis has been altered, after yAxis was created. You might get unexpected yAxis behavior. Make calls to useRightYAxis sooner in your chart creation process."), et = t, e) : et
                    ...
                    var t = et ? e.width() - e.margins().right : e._yAxisX();
                    e.renderYAxisAt("y", N, t);
                    var n = et ? e.width() - P : P,
                        r = et ? 90 : -90;
                    e.renderYAxisLabel("y", e.yAxisLabel(), r, n)
                }, e._renderHorizontalGridLinesForAxis = function(t, r, i) {
                    var a = t.select("g.horizontal");
                    if (V) {
                        var o = i.tickValues() ? i.tickValues() : r.ticks.apply(r, i.tickArguments());
                        a.empty() && (a = t.insert("g", ":first-child").attr("class", f + " horizontal").attr("transform", "translate(" + e.margins().left + "," + e.margins().top + ")"));
                        ...
                        n.transition(u, e.transitionDuration(), e.transitionDelay()).attr("opacity", 1);
                        var c = u.merge(l);
                        n.transition(c, e.transitionDuration(), e.transitionDelay()).attr("x1", 1).attr("y1", function(t) {
                            return r(t)
                        }).attr("x2", e.xAxisLength()).attr("y2", function(t) {
                            return r(t)
                        }), l.exit().remove()
                    ...
                    return arguments.length ? (D = t, e.margins().left -= P, P = void 0 === n ? 12 : n, e.margins().left += P, e) : D
                }, e.y = function(t) {
                    return arguments.length ? (k = t, e.rescale(), e) : k
                }, e.yAxis = function(t) {
                    return arguments.length ? (N = t, e) : (N || (N = i()), N)
                    ...
                    return n.utils.subtract(r, O, B)
                }, e.xAxisMax = function() {
                    var r = t.max(e.data(), function(t) {
                        return e.keyAccessor()(t)
                    });
                    return n.utils.add(r, O, B)
                }, e.yAxisMin = function() {
                    var r = t.min(e.data(), function(t) {
                        return e.valueAccessor()(t)
                    });
                    return n.utils.subtract(r, H)
                }, e.yAxisMax = function() {
                    var r = t.max(e.data(), function(t) {
                        return e.valueAccessor()(t)
                    });
                    return n.utils.add(r, H)
                    ...
                    return arguments.length ? (tt = t, e) : tt
                    ...
                    Y && (U.on("start brush end", e._brushing), C = t.append("g").attr("class", "brush").attr("transform", "translate(" + e.margins().left + "," + e.margins().top + ")"), e.setBrushExtents(), e.createBrushHandlePaths(C, n), e.redrawBrush(e.filter(), n))
                }, e.createBrushHandlePaths = function(t) {
                    var n = t.selectAll("path." + g).data([{
                        type: "w"
                    }, {
                        type: "e"
                    }]);
                    (n = n.enter().append("path").attr("class", g).merge(n)).attr("d", e.resizeHandlePath)
                    ...
                    if (Y && C)
                        if (X && e.setBrushExtents(r), t) {
                            var i = [x(t[0]), x(t[1])],
                                a = n.optionalTransition(r, e.transitionDuration(), e.transitionDelay())(C);
                            a.call(U.move, i), a.selectAll("path." + g).attr("display", null).attr("transform", function(e, n) {
                                return "translate(" + x(t[n]) + ", 0)"
                            }).attr("d", e.resizeHandlePath)
                        } else C.call(U.move, null), C.selectAll("path." + g).attr("display", "none");
                    ...
                    return e.resetSvg(), e._preprocessData(), e._generateG(), o(), l(!0), m = x.copy(), J ? e._enableMouseZoom() : Z && e._disableMouseZoom(), e
                    ...
                    if (j.scaleExtent(q).extent(t).duration(e.transitionDuration()), W) {
                        var n = Math.max(q[0], 1);
                        j.translateExtent(t).scaleExtent([n, q[1]])
                    }
                    e.root().call(j), c()
                }, e._disableMouseZoom = function() {
                    e.root().call(K)
                }, e.focus = function(t, e) {
                    W && (t = s(t, A), R && (t = s(t, R.x().domain()))), u(t, e), c()
                }, e.refocused = function() {
                    return !d(e.x().domain(), A)
                }, e.focusChart = function(t) {
                    return arguments.length ? (S = t, e.on("filtered", function(t) {
                        t.filter() ? d(t.filter(), S.filter()) || n.events.trigger(function() {
                            S.focus(t.filter(), !0)
                        }) : n.events.trigger(function() {
                            S.x().domain(S.xOriginalDomain(), !0)
                        })
                    }), e) : S
                ...
                function i() {
                    var e = t.min([M.width(), M.height()]) / 2;
                    p = y && y < e ? y : e;
                    var r, i = u(),
                        g = t.pie().sort(null).value(M.cappedValueAccessor);
                    if (t.sum(M.data(), M.valueAccessor()) ? (r = g(M.data()), v.classed(C, !1)) : (r = g([{
                            key: w,
                            value: 1,
                            others: [w]
                        }]), v.classed(C, !0)), v) {
                        ...
                        function(t, e, r, i) {
                            ...
                            (function(t, e) {
                                var r = t.append("path").attr("fill", d).on("click", f).attr("d", function(t, n) {
                                    ...
                                    i = n.transition(r, M.transitionDuration(), M.transitionDelay());
                                i.attrTween && i.attrTween("d", s)
                            })(u, r),
                            function(t) {
                                M.renderTitle() && t.append("title").text(function(t) {
                        ...
                        function(t, e) {
                            ...
                            function(t) {
                                M.renderTitle() && v.selectAll("g." + b).data(t).select("title").text(function(t) {
                                    return M.title()(t.data)
                                })
                            }(t)
                        }(r, i), M.hasFilter() ? M.selectAll("g." + b).each(function(t) {
                            c(t) ? M.highlightSelected(this) : M.fadeDeselected(this)
                        }) : M.selectAll("g." + b).each(function() {
                            M.resetHighlight(this)
                        }), n.transition(v, M.transitionDuration(), M.transitionDelay()).attr("transform", "translate(" + M.cx() + "," + M.cy() + ")")
                    }
                }

                function a(e, r) {
                    M._applyLabelText(e), n.transition(e, M.transitionDuration(), M.transitionDelay()).attr("transform", function(e) {
                        return function(e, n) {
                            var r;
                ...
                function o(t, e) {
                    M.select("g.pie-slice._" + t).classed("highlight", e)
                }
                ...
                function l(e, r) {
                    ...
                    var a = t.arc().outerRadius(p - R + A).innerRadius(p - R),
                        l = n.transition(i, M.transitionDuration(), M.transitionDelay());
                ...
                function f(t, e) {
                    v.attr("class") !== C && M.onClick(t.data, e)
                }
                ...
                return M.colorAccessor(M.cappedKeyAccessor), M.title(function(t) {
                ...
                }), M.slicesCap = M.cap, M.label(M.cappedKeyAccessor), M.renderLabel(!0), M.transitionDuration(350), M.transitionDelay(0), M._doRender = function() {
                    return M.resetSvg(), (v = M.svg().append("g").attr("transform", "translate(" + M.cx() + "," + M.cy() + ")")).append("g").attr("class", k), v.append("g").attr("class", D), i(), M
                }, M._applyLabelText = function(t) {
                    t.text(function(t) {
                        return ! function(t) {
                            return 0 === M.cappedValueAccessor(t)
                        }(t.data) && ! function(t) {
                            var e = t.endAngle - t.startAngle;
                            return isNaN(e) || e < S
                        }(t) || c(t) ? M.label()(t.data) : ""
                    })
                }, M.externalRadiusPadding = function(t) {
                    ...
                    return arguments.length ? (x = t, M) : x || M.width() / 2
                }, M.cy = function(t) {
                    return arguments.length ? (m = t, M) : m || M.height() / 2
                }, M._doRedraw = function() {
                    return i(), M
                }, M.minAngleForLabel = function(t) {
                    return arguments.length ? (S = t, M) : S
                }, M.emptyTitle = function(t) {
                    return 0 === arguments.length ? w : (w = t, M)
                }, M.externalLabels = function(t) {
                    return 0 === arguments.length ? A : (A = t || void 0, M)
                }, M.drawPaths = function(t) {
                    return 0 === arguments.length ? E : (E = t, M)
                ...
                function i() {
                    g = g || t.min([D.width(), D.height()]) / 2;
                    var e, r = o();
                    if (t.sum(D.data(), D.valueAccessor()) ? ((e = l(n.utils.toHierarchy(D.data(), D.valueAccessor()))).shift(), p.classed(A, !1)) : (e = l(n.utils.toHierarchy([], function(t) {
                            return t.value
                        })), p.classed(A, !0)), p) {
                        var i = p.selectAll("g." + m).data(e);
                        ! function(t, e, r) {
                            var i = function(t) {
                                return t.enter().append("g").attr("class", function(t, e) {
                                    return m + " _" + e + " " + m + "-level-" + t.depth
                                })
                            }(t);
                            (function(t, e) {
                                var r = t.append("path").attr("fill", c).on("click", d).attr("d", function(t, n) {
                                        return f(t, n, e)
                                    }),
                                    i = n.transition(r, D.transitionDuration());
                                i.attrTween && i.attrTween("d", u)
                            })(i, e),
                            function(t) {
                                D.renderTitle() && t.append("title").text(function(t) {
                                    return D.title()(t)
                                })
                            }(i),
                            function(t, e) {
                        ...
                        function(t, e) {
                            (function(t, e) {
                                var r = p.selectAll("g." + m).data(t).select("path").attr("d", function(t, n) {
                                        return f(t, n, e)
                                    }),
                                    i = n.transition(r, D.transitionDuration());
                                i.attrTween && i.attrTween("d", u);
                            ...
                            function(t) {
                                D.renderTitle() && p.selectAll("g." + m).data(t).select("title").text(function(t) {
                                    return D.title()(t)
                                })
                            }(t)
                        }(e, r),
                        function(t) {
                            t.exit().remove()
                        }(i), D.hasFilter() ? D.selectAll("g." + m).each(function(t) {
                            ! function(t) {
                                return function(t) {
                            ...
                            }(t) ? D.fadeDeselected(this): D.highlightSelected(this)
                        }) : D.selectAll("g." + m).each(function(t) {
                ...
                function a(e, r) {
                    n.transition(e, D.transitionDuration()).attr("transform", function(e) {
                        return function(e, n) {
                            var r;
                            r = x ? t.svg.arc().outerRadius(g + x).innerRadius(g + x).centroid(e) : n.centroid(e);
                            return isNaN(r[0]) || isNaN(r[1]) ? "translate(0,0)" : "translate(" + r + ")"
                        }(e, r)
                    }).attr("text-anchor", "middle").text(function(t) {
                        return function(t) {
                            return 0 === D.cappedValueAccessor(t)
                        }(t) || function(t) {
                            var e = t.x1 - t.x0;
                            return isNaN(e) || e < k
                        }(t) ? "" : D.label()(t)
                ...
                function o() {
                    return t.arc().startAngle(function(t) {
                        ...
                        return t.data.path && 1 === t.data.path.length ? _ : Math.sqrt(t.y0)
                ...
                function l(e) {
                    var n = t.hierarchy(e).sum(function(t) {
                        return t.children ? 0 : D.cappedValueAccessor(t)
                    }).sort(function(e, n) {
                        return t.ascending(e.data.path, n.data.path)
                    });
                    t.partition().size([2 * Math.PI, g * g])(n);
                ...
                function u(e) {
                    ...
                    var n = this._current;
                    (function(t) {
                        return !t || isNaN(t.dx) || isNaN(t.dy)
                    })(n) && (n = {
                        x: 0,
                        y: 0,
                        dx: 0,
                    ...
                    return this._current = i(0),
                        function(t) {
                            return f(Object.assign({}, e, i(t)), 0, o())
                        }
                }

                function c(t, e) {
                    return D.getColor(t, e)
                }

                function s(t) {
                    for (var e = t.path || t.key, r = n.filters.HierarchyFilter(e), i = function(t) {
                            for (var e = n.filters.HierarchyFilter(t), r = [], i = 0; i < D.filters().length; i++) {
                                var a = D.filters()[i];
                        ...
                        var l = i[o];
                        n.utils.arraysIdentical(l, e) && (a = !0), D.filter(i[o])
                    }
                    n.events.trigger(function() {
                        a || D.filter(r), D.redrawGroup()
                    })
                }
                ...
                function h(e, n) {
                    D.selectAll("g.pie-slice").each(function(r) {
                        e.name === r.key && t.select(this).classed("highlight", n)
                    })
                }
                var g, p, y, v, x, m = "pie-slice",
                    A = "empty-chart",
                    b = "empty",
                    _ = 0,
                    k = .5,
                    D = n.capMixin(n.colorMixin(n.baseMixin({})));
                return D.colorAccessor(D.cappedKeyAccessor), D.title(function(t) {
                    return D.cappedKeyAccessor(t) + ": " + D.cappedValueAccessor(t)
                }), D.label(D.cappedKeyAccessor), D.renderLabel(!0), D.transitionDuration(350), D.filterHandler(function(t, e) {
                    ...
                    return D.resetSvg(), p = D.svg().append("g").attr("transform", "translate(" + D.cx() + "," + D.cy() + ")"), i(), D
                }, D.innerRadius = function(t) {
                    return arguments.length ? (_ = t, D) : _
                }, D.radius = function(t) {
                    return arguments.length ? (g = t, D) : g
                }, D.cx = function(t) {
                    return arguments.length ? (y = t, D) : y || D.width() / 2
                }, D.cy = function(t) {
                    return arguments.length ? (v = t, D) : v || D.height() / 2
                }, D.minAngleForLabel = function(t) {
                    return arguments.length ? (k = t, D) : k
                }, D.emptyTitle = function(t) {
                    return 0 === arguments.length ? b : (b = t, D)
                }, D.externalLabels = function(t) {
                    return 0 === arguments.length ? x : (x = t || void 0, D)
                }, D._doRedraw = function() {
                    return i(), D
                }, D.onClick = d, D.legendables = function() {
                    return D.data().map(function(t, e) {
                        ...
                        return n.color = D.getColor(t, e), n
                    })
                }, D.legendHighlight = function(t) {
                    h(t, !0)
                }, D.legendReset = function(t) {
                    h(t, !1)
                }, D.legendToggle = function(t) {
                    D.onClick({
                        key: t.name,
                        others: t.others
                    })
                    ...
                    if ("always" === x.xyTipsOn() || !x.brushOn() && !x.parentBrushOn() && x.xyTipsOn()) {
                        ...
                        a.empty() && (a = e.append("g").attr("class", i)), r.each(function(e, r) {
                            ...
                            var l = o.selectAll("circle." + g).data(i, n.pluck("x")),
                                ...
                                }).attr("r", u()).style("fill-opacity", _).style("stroke-opacity", k).attr("fill", x.getColor).on("mousemove", function() {
                                    var e = t.select(this);
                                    ! function(t) {
                ...
                return x.transitionDuration(500), x.transitionDelay(0), x._rangeBandPadding(1), x.plotData = function() {
                    ...
                    return arguments.length ? (t ? (_ = t.fillOpacity || .8, k = t.strokeOpacity || .8, b = t.radius || 2) : (_ = 1e-6, k = 1e-6, b = null), x) : {
                        fillOpacity: _,
                        strokeOpacity: k,
                        radius: b
                    }
                ...
                return f._mandatoryAttributes([]), f.transitionDuration(500), f.transitionDelay(0), n.override(f, "_generateG", function() {
                    ...
                    return t
                }), f.applyBrushSelection = function(t) {
                    f.replaceFilter(t);
                    for (var e = 0; e < h.length; ++e) h[e].replaceFilter(t);
                    f.redrawGroup()
                ...
                function a() {
                    ...
                    function(t) {
                        ...
                        n.transition(i, D.transitionDuration(), D.transitionDelay()).attr("width", function(t) {
                                return Math.abs(o() - d(D.valueAccessor()(t)))
                            }).attr("transform", u),
                            function(t) {
                ...
                return l.brush(t.brush()), u.size(i), n.override(l, "_filter", function(t) {
                    ...
                    (t = t.enter().append("path").attr("class", "symbol").attr("opacity", 0).attr("fill", l.getColor).attr("transform", d).merge(t)).call(a, l.data()), t.each(function(t, e) {
                    ...
                    }).attr("transform", d).attr("d", u), n.transition(t.exit(), l.transitionDuration(), l.transitionDelay()).attr("opacity", 0).remove()
                ...
                return n.override(g, "filter", function(t) {
                    ...
                    }).on("click", g.boxOnClick()), g.renderTitle() && (v.append("title"), y.select("title").text(g.title())), y = v.merge(y), n.transition(y.select("rect"), g.transitionDuration(), g.transitionDelay()).attr("x", function(t, e) {
                        return r(g.keyAccessor()(t, e))
                    }).attr("y", function(t, n) {
                        return e(g.valueAccessor()(t, n))
            ...
            function() {
                    ...
                    function i(e) {
                        e.each(function(e, n) {
                            ...
                            var r = t.select(this),
                                ...
                                y = e.quartiles = f(e),
                                v = d && d.call(this, e, n),
                                x = v && v.map(function(t) {
                                    return e[t]
                                }),
                                m = v ? t.range(0, v[0]).concat(t.range(v[1] + 1, i)) : t.range(i),
                                A = t.scaleLinear().domain(c && c.call(this, e, n) || [g, p]).range([o, 0]),
                                b = this.__chart__ || t.scaleLinear().domain([0, 1 / 0]).range(A.range());
                            this.__chart__ = A;
                            var _ = r.selectAll("line.center").data(x ? [x] : []);
                            _.enter().insert("line", "rect").attr("class", "center").attr("x1", a / 2).attr("y1", function(t) {
                                return b(t[0])
                                ...
                                return A(t[1])
                            }), _.transition().duration(l).delay(u).style("opacity", 1).attr("x1", a / 2).attr("x2", a / 2).attr("y1", function(t) {
                                return A(t[0])
                            }).attr("y2", function(t) {
                                return A(t[1])
                            }), _.exit().transition().duration(l).delay(u).style("opacity", 1e-6).attr("y1", function(t) {
                                return A(t[0])
                            }).attr("y2", function(t) {
                                return A(t[1])
                            }).remove();
                            var k = r.selectAll("rect.box").data([y]);
                            k.enter().append("rect").attr("class", "box").attr("x", 0).attr("y", function(t) {
                                return b(t[2])
                            }).attr("width", a).attr("height", function(t) {
                                return b(t[0]) - b(t[2])
                            }).transition().duration(l).delay(u).attr("y", function(t) {
                                return A(t[2])
                            }).attr("height", function(t) {
                                return A(t[0]) - A(t[2])
                            }), k.transition().duration(l).delay(u).attr("width", a).attr("y", function(t) {
                                return A(t[2])
                            }).attr("height", function(t) {
                                return A(t[0]) - A(t[2])
                            });
                            var D = r.selectAll("line.median").data([y[1]]);
                            D.enter().append("line").attr("class", "median").attr("x1", 0).attr("y1", b).attr("x2", a).attr("y2", b).transition().duration(l).delay(u).attr("y1", A).attr("y2", A), D.transition().duration(l).delay(u).attr("x1", 0).attr("x2", a).attr("y1", A).attr("y2", A);
                            var C = r.selectAll("line.whisker").data(x || []);
                            C.enter().insert("line", "circle, text").attr("class", "whisker").attr("x1", 0).attr("y1", b).attr("x2", a).attr("y2", b).style("opacity", 1e-6).transition().duration(l).delay(u).attr("y1", A).attr("y2", A).style("opacity", 1), C.transition().duration(l).delay(u).attr("x1", 0).attr("x2", a).attr("y1", A).attr("y2", A).style("opacity", 1), C.exit().transition().duration(l).delay(u).attr("y1", A).attr("y2", A).style("opacity", 1e-6).remove();
                            var w = r.selectAll("circle.outlier").data(m, Number);
                            w.enter().insert("circle", "text").attr("class", "outlier").attr("r", 5).attr("cx", a / 2).attr("cy", function(t) {
                                return b(e[t])
                            }).style("opacity", 1e-6).transition().duration(l).delay(u).attr("cy", function(t) {
                                return A(e[t])
                            }).style("opacity", 1), w.transition().duration(l).delay(u).attr("cx", a / 2).attr("cy", function(t) {
                                return A(e[t])
                            }).style("opacity", 1), w.exit().transition().duration(l).delay(u).attr("cy", function(t) {
                                return A(e[t])
                            }).style("opacity", 1e-6).remove();
                            var L = h || A.tickFormat(8),
                                R = r.selectAll("text.box").data(y);
                            R.enter().append("text").attr("class", "box").attr("dy", ".3em").attr("dx", function(t, e) {
                                return 1 & e ? 6 : -6
                            }).attr("x", function(t, e) {
                                return 1 & e ? a : 0
                            }).attr("y", b).attr("text-anchor", function(t, e) {
                                return 1 & e ? "start" : "end"
                            }).text(L).transition().duration(l).delay(u).attr("y", A), R.transition().duration(l).delay(u).text(L).attr("x", function(t, e) {
                                return 1 & e ? a : 0
                            }).attr("y", A);
                            var S = r.selectAll("text.whisker").data(x || []);
                            S.enter().append("text").attr("class", "whisker").attr("dy", ".3em").attr("dx", 6).attr("x", a).attr("y", b).text(L).style("opacity", 1e-6).transition().duration(l).delay(u).attr("y", A).style("opacity", 1), S.transition().duration(l).delay(u).text(L).attr("x", a).attr("y", A).style("opacity", 1), S.exit().transition().duration(l).delay(u).attr("y", A).style("opacity", 1e-6).remove()
                        }), t.timerFlush()
                    }
                    var a = 1,
                        o = 1,
                ...
                var i = n.coordinateGridMixin({}),
                    ...
                    l = null,
                    u = function(t, e) {
                        return i.isOrdinal() ? i.x().bandwidth() : t / (1 + i.boxPadding()) / e
                    };
                i.yAxisPadding(12), i.x(t.scaleBand()), i.xUnits(n.units.ordinal), i.data(function(t) {
                ...
                }), i.boxPadding = i._rangeBandPadding, i.boxPadding(.8), i.outerPadding = i._outerRangeBandPadding, i.outerPadding(.5), i.boxWidth = function(t) {
                    return arguments.length ? (u = "function" == typeof t ? t : n.utils.constant(t), i) : u
                };
                var c = function(t, e) {
                ...
                return i._preprocessData = function() {
                    ...
                    var e = u(i.effectiveWidth(), i.xUnitCount());
                    o.whiskers(a).width(e).height(i.effectiveHeight()).value(i.valueAccessor()).domain(i.y().domain()).duration(i.transitionDuration()).tickFormat(l);
                    var r = i.chartBodyG().selectAll("g.box").data(i.data(), i.keyAccessor());
                    ! function(e) {
                        n.transition(e, i.transitionDuration(), i.transitionDelay()).attr("transform", c).call(o).each(function() {
                            t.select(this).select("rect.box").attr("fill", i.getColor)
                        })
                    }(function(t) {
                        var e = t.enter().append("g");
                        return e.attr("class", "box").attr("transform", c).call(o).on("click", function(t) {
                            i.filter(i.keyAccessor()(t)), i.redrawGroup()
                        }), e.merge(t)
                    }(r)),
                    function(t) {
                        t.exit().remove().call(o)
                    }(r), i.fadeDeselectedArea(i.filter())
                }, i.fadeDeselectedArea = function(t) {
                    if (i.hasFilter())
                        if (i.isOrdinal()) i.g().selectAll("g.box").each(function(t) {
                            i.isSelectedNode(t) ? i.highlightSelected(this) : i.fadeDeselected(this)
                        });
                        else {
                            if (!i.brushOn() && !i.parentBrushOn()) return;
                            var e = t[0],
                                n = t[1],
                                r = i.keyAccessor();
                            i.g().selectAll("g.box").each(function(t) {
                                var a = r(t);
                                a < e || a >= n ? i.fadeDeselected(this) : i.highlightSelected(this)
                            })
                        } else i.g().selectAll("g.box").each(function() {
                        i.resetHighlight(this)
                    })
                }, i.isSelectedNode = function(t) {
                    return i.hasFilter(i.keyAccessor()(t))
                }, i.yAxisMin = function() {
